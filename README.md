> [!NOTE]
> This fork of the Eleventy Base Blog features integration with [Eleventy Plugin Baseline](https://eleventy-plugin-baseline.netlify.app/).  
> Default branch is `baseline-edition`, integration commits follow the steps documented in [Integrate Baseline with Eleventy Base Blog](https://eleventy-plugin-baseline.netlify.app/docs/how-to/integrate-eleventy-base-blog/). The `main` branch is reserved for upstream changes.
